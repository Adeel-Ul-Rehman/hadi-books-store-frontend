                  ...
                  >
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-300 p-6 max-w-md w-full">
                      ...
                      <button
                        ...
                        className="w-full mb-4 flex items-center justify-center gap-3 py-3 px-4 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-all duration-300"
                      >
